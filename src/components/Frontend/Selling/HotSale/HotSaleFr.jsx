...
const HotSaleFr = ({ hot }) => {
  const { image, name, price, stock, _id, duration, category, purchased } = hot;
    ...
    <div className="card lg:w-72 mb-10 w-60 h-96 mx-auto bg-base-100 shadow-xl lg:ml-6 hover:scale-110 px-2 text-slate-50 bg-gradient-to-r from-blue-700 to-slate-600">
      ...
      <div className="card-body items-center text-center">
        <h2 className="font-bold mt-[-24px] text-xl">
          {hot?.name.substring(0, 15)}
        </h2>
        <p className="text-md">Price: {hot?.price} BDT</p>
        <p className="text-sm">Validity: {hot?.duration} Days</p>
        <p className="text-sm">Stock: {hot?.stock}</p>
        <div className="">
