        ...
        <SwiperSlide>
          ...
          >
            ...
            <div className="hero-content text-center text-neutral-content">
              <div className="max-w-2xl lg:mt-[-270px]  mt-[-550px]">
          ...
          >
            ...
            <div className="hero-content text-center text-neutral-content">
              <div className="max-w-2xl lg:mt-[-270px]  mt-[-550px]">
                ...
                <p className="mb-5">Plans now start at 2999৳.</p>
                <div className="button-area flex justify-center gap-10 lg:mt-0 mt-10">
        ...
        <SwiperSlide>
          ...
          >
            ...
            <div className="hero-content text-center text-neutral-content text-center">
              <div className="lg:max-w-full 2xl:max-w-full xl:max-w-full max-w-md lg:mt-[-270px]  mt-[-550px]">
            ...
            <div className="button-area lg:flex lg:justify-between mx-auto lg:items-center gap-10 xl:mt-[190px] lg:mt-[100px] text-xl">
