          ...
          <div class="flex flex-col items-center">
            ...
            >
              <SwiperSlide className="">
                <div class="flex flex-col overflow-hidden shadow-xl gap-10 ">
                  <div class="flex flex-col justify-between flex-1 p-6 bg-white lg:py-8 lg:px-7 text-slate-50 bg-gradient-to-r from-blue-700 to-red-500">
                    <div class="flex-1">
                      ...
                      <blockquote class="flex-1 mt-8">
                        <p class="text-lg leading-relaxed text-slate-50 font-pj">
                    ...
                    <div class="flex items-center mt-8">
                      ...
                      />
                      <div class="ml-4">
                        <p class="text-base font-bold text-slate-100 font-pj">
                          Leslie Alexander
                        </p>
                        <p class="mt-0.5 text-sm font-pj text-gray-900 font-bold">
...
export default ClientTesitimonial;
