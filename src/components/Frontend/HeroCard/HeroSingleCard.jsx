...
const HeroSingleCard = ({ image, title, description }) => {
  return (
    <div className="card-1 group ">
      <div className="rounded-xl max-w-2xl mx-auto mb-5 text-center card-compact w-96 py-5 shadow-xl text-slate-50 bg-gradient-to-r from-red-700 to-red-500 group-hover:scale-110">
        <figure>
